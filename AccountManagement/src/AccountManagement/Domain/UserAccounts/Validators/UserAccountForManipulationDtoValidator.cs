...
public class UserAccountForManipulationDtoValidator<T> : AbstractValidator<T> where T : UserAccountForManipulationDto
{
    public UserAccountForManipulationDtoValidator()
    {
