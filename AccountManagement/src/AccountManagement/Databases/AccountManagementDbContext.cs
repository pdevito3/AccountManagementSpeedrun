namespace AccountManagement.Databases;

using AccountManagement.Domain;
using AccountManagement.Databases.EntityConfigurations;
...
public sealed class AccountManagementDbContext : DbContext
{
    ...
    public AccountManagementDbContext(
        DbContextOptions<AccountManagementDbContext> options, ICurrentUserService currentUserService, IMediator mediator) : base(options)
    {
